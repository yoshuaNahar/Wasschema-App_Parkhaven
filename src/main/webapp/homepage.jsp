            ...
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                ...
                <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                  <div class="panel-body">
			        ...
			        <c:if test="${not empty sessionScope.user.email}">
					  <span>- <a class="settings_link" data-toggle="modal" data-target="#modify_account_housenumber_modal">Modify housenumber.</a></span><br>
					  <span>- <a class="settings_link" data-toggle="modal" data-target="#modify_account_password_modal">Modify password.</a></span><br>
