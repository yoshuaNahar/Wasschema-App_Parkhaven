...
<meta name="description"
	content="Wasrooster van de studentenflat Parkhaven in Rotterdam" />
	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand mainTitle" href="/WasSchema/">Parkhaven -
					Was Schema</a>
			</div>
...
<c:out value="${message.value.gebruikerMail}"></c:out>
				<form name="accept_prikbord_message_form" class="form-signin"
					...
					<input name="message_id" value="${message.value.id}"
						style="display: none;" required>
					<button type="submit" name="accept_prikbord_message" value="true"
						class="btn btn-succes btn-xs">
						Approve Message <span class="glyphicon glyphicon-ok"></span>
					</button>
					<button type="submit" name="accept_prikbord_message" value="false"
						class="btn btn-succes btn-xs">
