...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/login-and-signup-form.css" />
</head>
<body>
  ...
  <div class="initial_page">
    <div class="initial_form">
      ...
      <form id="register_form" action="" method="post">
        ...
        <input name="sharedcode" type="text" placeholder="shared code"/>
        <input name="to_servlet" value="register" style="display: none;" />
        <button>create</button> 
        <div class="message">
          <p class="float_right">Already registered? <a href="#" class="switch_between_login_create_form">Sign In</a></p>
        </div>
      </form>
      ...
      <form id="forgot_password_form" action="" method="post">
        ...
        <div class="message">
          <p class="float_right"><a href="#" class="goto_forgot">Sign In</a></p>
        </div>
      </form>
    </div>
  </div>
  ...
  // alert to show when values incorrect
