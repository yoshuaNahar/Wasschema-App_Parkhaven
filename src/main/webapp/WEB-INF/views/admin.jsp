...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand mainTitle" href="/WasSchema/index.010">Parkhaven - Wasschema</a>
    </div>

    <div id="navbar" class="navbar-collapse collapse">
      <div class="navbar-form navbar-right">
        <div id="login_information">Logged in as <c:out
...
<div class="col-sm-9 col-md-10 main">
  <div class="row">
    ...
    <c:forEach var="message" items="${prikbord_messages}">
      ...
      <form name="accept_prikbord_message_form" class="form-signin" action="admin.010"
            method="post">
        ...
        <button type="submit" name="messageAccepted" value="true"
                class="btn btn-succes btn-xs">
          Approve Message <span class="glyphicon glyphicon-ok"></span>
        </button>
        <button type="submit" name="messageAccepted" value="false"
                class="btn btn-succes btn-xs">
...
<div class="col-sm-8 col-md-8 main">
  <div class="row">
    <h4 class="page-header">Laundry Machines:</h4>
    <form id="getMachinesForm" action="admin.010" method="post">
      <input name="to_servlet" value="getAllMachines" style="display: none;">
      <input type="submit" name="submit" value="Get All Laundry Machines"/>
    </form>
    <br>
    <table class="table table-striped">
      <c:forEach items="${requestScope.machines}" var="entry" varStatus="loop">
        <tr data-id="${entry.key}">
          <td>${entry.value}</td>
          <td>
            <button class="deleteButton" value="${entry.key}" data-toggle="modal"
                    data-target="#disable_machine_model">
              Delete
            </button>
          <td>
        </tr>
...
<div class="col-sm-8 col-md-8 main">
  <div class="row">
    ...
    <form id="searchUserForm" action="admin.010" method="post">
      ...
      <input type="submit" name="submit" value="Get All Users"/>
    </form>
    <br>
    <table class="table table-striped">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-xs-9 col-xs-offset-1">
              <input id="id" type="text" name="id" class="form-control settings_modal"
                     readonly/>
              <input id="email" name="email" type="text"
                     class="form-control settings_modal" readonly/>
              <input id="password" style="display: none;" name="password" type="text"
                     class="form-control settings_modal" readonly/>
              <input id="housenumber" name="houseNumber" type="text"
                     class="form-control settings_modal" readonly/>
              <input name="to_servlet" value="deleteSelectedUser"
