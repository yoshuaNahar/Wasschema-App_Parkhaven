  ...
  <div class="initial_page">
    <div class="initial_form">
      ...
      <form id="register_form" action="" method="post">
        ...
        <input id="confirm_password" type="password" placeholder="repeat password" required pattern="" title="Password not identical"/>
        ...
        <div class="message">
          <p class="float_right">
            Already registered? <a href="#" class="switch_between_login_create_form">Sign In</a>
          </p>
        </div>
      </form>
