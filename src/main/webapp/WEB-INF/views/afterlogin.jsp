  ...
  <div class="row">
          ...
          <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
            ...
            <div class="panel panel-default">
              <div class="panel-heading" role="tab" id="headingFour">
                <h4 class="panel-title">
                  <a id="left_menu_header" class="collapsed" role="button" data-toggle="collapse"
            ...
            <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                <div class="panel-body">
                  ...
                  <a class="settings_link" data-toggle="modal" data-target="#modify_account_password_modal">Change
                    password</a>
                  <hr class="smaller_margin">
          ...
          <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
            <div class="panel panel-default">
              <div class="panel-heading" role="tab" id="headingOne">
                <h4 class="panel-title">
                  <img src="${pageContext.request.contextPath}/resources/img/prikbord.png" data-toggle="modal"
                ...
                <div id="prikbord_body" class="panel-body">
                  ...
                  <c:forEach var="message" items="${prikbord_messages}">
                    ...
                    <c:if test="${message.value.userId == sessionScope.user.id || sessionScope.user.admin}">
                      <button id="save_message_id" data-title="${message.value.titleOutput}" data-id="${message.key}"
                              type="button"
                              data-toggle="modal" data-target="#delete_message_modal" class="btn btn-default btn-xs">
                        Remove message
                      </button>
                    </c:if>
    ...
    <div class="col-xs-10 col-xs-offset-2 main">
      ...
      <c:if test="${requestScope.laundryRoom == 1 || requestScope.laundryRoom == 2 || requestScope.laundryRoom == 3}">
        <nav aria-label="week_pagination" id="week">
          <ul class="pager">
            <c:if test="${requestScope.week != 'next'}">
              ...
              <li class="label"><a id="available_week" href="?week=next&laundryRoom=${requestScope.laundryRoom}">Next
                Week <span
        ...
        <div class="legend">
          <c:if test="${requestScope.laundryRoom == 1}">
            <small><span class="label" id="blue">Laundrymachine A1</span> <b>-</b> <span class="label" id="yellow">Laundrymachine A2</span>
            </small>
          </c:if>
          <c:if test="${requestScope.laundryRoom == 2}">
            <small><span class="label" id="blue">Laundrymachine B1</span> <b>-</b> <span class="label" id="yellow">Laundrymachine B2</span>
            </small>
          </c:if>
          <c:if test="${requestScope.laundryRoom == 3}">
            <small><span class="label" id="blue">Laundrymachine C1</span> <b>-</b> <span class="label" id="yellow">Laundrymachine C2</span>
            </small>
          </c:if>
        </div>
        ...
        <div class="legend">
          <c:if test="${requestScope.laundryRoom == 1}">
            <small><span class="label" id="green">Dryer A3</span> <b>-</b> <span class="label" id="red">Dryer A4</span>
            </small>
          </c:if>
          <c:if test="${requestScope.laundryRoom == 2}">
            <small><span class="label" id="green">Dryer B3</span> <b>-</b> <span class="label" id="red">Dryer B4</span>
            </small>
          </c:if>
          <c:if test="${requestScope.laundryRoom == 3}">
            <small><span class="label" id="green">Laundrymachine C3</span> <b>-</b> <span class="label" id="red">Laundrymachine C4</span>
            </small>
          </c:if>
        </div>
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-xs-9 col-xs-offset-1">
              <input id="password" name="password" type="password" class="form-control settings_modal"
                     placeholder="New Password" required/> <br>
              <input id="confirm_password" type="password" class="form-control" placeholder="Retype Password" pattern=""
...
<div class="modal fade" id="delete_account_modal" role="dialog" data-controls-modal="delete_account_modal"
    ...
    <div class="modal-content">
      ...
      <form name="delete_account" class="form-signin" action="index.010" method="post">
        <div class="modal-body">
          <div class="row">
            <div class="col-xs-9 col-xs-offset-1">
              <input name="password" type="password" class="form-control settings_modal" placeholder="Type password"
                     required/>
      ...
      <form name="appointment_form" class="form-signin" action="index.010" method="post">
        <div class="modal-body inputSpread">
          ...
          <div class="row">
            ...
            <div class="col-xs-8 .col-xs-offset-4">
              <input value="${sessionScope.user.houseNumber}" name="huisnummer" type="text"
          ...
          <input value="${sessionScope.user.id}" name="id" type="number" style="display: none;" required> <input
                name="to_servlet"
...
<div class="modal fade" id="delete_appointment_modal" role="dialog" data-controls-modal="delete_appointment_modal"
     data-backdrop="static"
     data-keyboard="false">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
...
<div class="modal fade" id="delete_message_modal" role="dialog" data-controls-modal="delete_message_modal"
     data-backdrop="static"
     data-keyboard="false">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
    ...
    <div class="modal-content">
      ...
      <form name="prikbord_form" class="form-prikbord" action="index.010" method="post">
        ...
        <div class="modal-body inputSpread">
          ...
          <input value="${sessionScope.user.id}" name="userId" type="number" style="display: none;" required> <input
                name="to_servlet"
...
<div id="error_message_modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
