...
<head>
  ...
  <link rel="icon" href="${pageContext.request.contextPath}/resources/img/favicon.ico"
        type="image/x-icon">
  <link rel="stylesheet"
        href="${pageContext.request.contextPath}/resources/css/bootstrapEdited.css"/>
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand mainTitle" href="${pageContext.request.contextPath}/index.010">
        <img id="menu_img"
             src="${pageContext.request.contextPath}/resources/img/parkhaven-logo.png"/>
        <span id="menu_span">Was Schema</span>
      </a>
    </div>
    ...
    <div class="navbar-form navbar-right">
      <c:if test="${not empty sessionScope.user.email}">
        ...
        <c:if test="${sessionScope.user.admin}">
          <form id="adminForm" name="adminButton" class="form-signin" action="admin.010"
                method="get">
            <button type="submit" class="btn btn-succes">Admin page</button>
          </form>
        </c:if>
        <form id="logoutForm" name="logoutButton" class="form-signin" action="index.010"
              method="post">
  ...
  <div class="row">
    <div class="col-xs-2 sidebar">
      <ul class="nav nav-sidebar">
        <li class="active dashBoard_margin"><a class="dashBoard_boldness">Dashboard <span
            class="shrink_glyph glyphicon glyphicon-home"></span><span
          ...
          <div class="panel-group" id="accordion" role="tablist"
            ...
            <div class="panel panel-default">
              <div class="panel-heading" role="tab" id="headingFour">
                <h4 class="panel-title">
                  <a id="left_menu_header" class="collapsed" role="button"
              ...
              <div id="collapseFour" class="panel-collapse collapse" role="tabpanel"
                ...
                <div class="panel-body">
                  <form id="rememberLaundryRoom" name="rememberLaundryRoom"
                        action="index.010" method="post">
                    <p>Remember Laundry Room:
                      <input id="remember_laundry_room_checkbox"
                             type="checkbox" name="rememberLaundryRoomChecked"
                             value='true'
                             onchange="$('#rememberLaundryRoom').submit();"
                             <c:if
                                 test="${sessionScope.user.rememberLaundryRoomChecked}">checked</c:if>>
                      <span id="remember_laundry_room_sign"
                            class="shrink_glyph glyphicon glyphicon-question-sign"
                            data-toggle="tooltip" data-placement="left"
                            title="To show your laundry room when logging in."></span>
                      <input name="to_servlet" value="rememberLaundryRoom"
                             style="display: none;" required>
                      <input value="${requestScope.week}" name="week"
                             type="text" style="display: none;"><input
                          value="${requestScope.laundryRoom}"
                          name="laundryRoom" type="number"
                          style="display: none;">
                    </p>
                  </form>
                  <hr class="smaller_margin">
                  <a class="settings_link" data-toggle="modal"
                     data-target="#modify_account_password_modal">Change
                    password</a>
                  <hr class="smaller_margin">
                  <a class="settings_link" data-toggle="modal"
                     data-target="#delete_account_modal">Delete account</a>
                </div>
              </div>
            </div>
            ...
            <div class="panel panel-default">
              <div class="panel-heading" role="tab" id="headingTwo">
                <h4 class="panel-title">
                  <a id="left_menu_header" class="collapsed" role="button"
                     ...
                     aria-expanded="true" aria-controls="collapseTwo">Choose
                    Laundry Room <img id="laundryroom_img"
              ...
              <div id="collapseTwo" class="panel-collapse collapse in" role="tabpanel"
                ...
                <div class="panel-body">
                  <c:if
                      test="${requestScope.laundryRoom != 1 && requestScope.laundryRoom != 2 && requestScope.laundryRoom != 3}">
                    <a class="settings_link"
                       href="?week=${requestScope.week}&laundryRoom=1">Laundry
                      room A</a>
                    <hr class="smaller_margin">
                    <a class="settings_link"
                       href="?week=${requestScope.week}&laundryRoom=2">Laundry
                      room B</a>
                    <hr class="smaller_margin">
                    <a class="settings_link"
                       href="?week=${requestScope.week}&laundryRoom=3">Laundry
                      room C</a>
                  </c:if>
                  <c:if test="${requestScope.laundryRoom == 1}">
                    <a class="settings_link">Laundry room A <span class="label"
                                                                  id="default_blue">(Current)</span></a>
                    <hr class="smaller_margin"/>
                    <a class="settings_link"
                       href="?week=${requestScope.week}&laundryRoom=2">Laundry
                      room B</a>
                  ...
                  <c:if test="${requestScope.laundryRoom == 2}">
                    <a class="settings_link"
                      ...
                      room A</a>
                    <hr class="smaller_margin"/>
                    <a class="settings_link">Laundry room B <span class="label"
                                                                  id="default_blue">(Current)</span></a>
                    <hr class="smaller_margin"/>
                    <a class="settings_link"
                       href="?week=${requestScope.week}&laundryRoom=3">Laundry
                  ...
                  <c:if test="${requestScope.laundryRoom == 3}">
                    ...
                    <a class="settings_link"
                      ...
                      room B</a>
                    <hr class="smaller_margin"/>
                    <a class="settings_link">Laundry room C <span class="label"
                                                                  id="default_blue">(Current)</span></a>
                  </c:if>
                </div>
              </div>
          ...
          <div class="panel-group" id="accordion" role="tablist"
            ...
            <div class="panel panel-default">
              <div class="panel-heading" role="tab" id="headingOne">
                <h4 class="panel-title">
                  <img src="${pageContext.request.contextPath}/resources/img/prikbord.png"
                       data-toggle="modal"
                       data-target="#prikbord_modal"
                       id="prikbord_header"/>
                </h4>
              </div>
              <div id="collapseOne" class="panel-collapse collapse in">
                <div id="prikbord_body" class="panel-body">
                  ...
                  <c:forEach var="message" items="${prikbord_messages}">
                    ...
                    <c:if
                        test="${message.value.userId == sessionScope.user.id || sessionScope.user.admin}">
                      <button id="save_message_id"
                              data-title="${message.value.titleOutput}"
                              data-id="${message.key}"
                              type="button"
                              data-toggle="modal"
    ...
    <div class="col-xs-10 col-xs-offset-2 main">
      ...
      <c:if
        ...
        <nav aria-label="week_pagination" id="week">
          <ul class="pager">
            <c:if test="${requestScope.week != 'next'}">
              ...
              <li class="label"><a id="available_week"
                                   href="?week=next&laundryRoom=${requestScope.laundryRoom}">Next
                Week <span
            ...
            <c:if test="${requestScope.week == 'next'}">
              <li class="label"><a id="available_week"
                                   href="?week=current&laundryRoom=${requestScope.laundryRoom}"><span
                  class="shrink_glyph glyphicon glyphicon-arrow-left"></span>
                Current Week</a></li>
        ...
        <nav aria-label="week_pagination" id="dryers">
          <ul class="pager">
            <li class="label"><a class="go_to_dryers" id="available_week">Dryers <span
                class="shrink_glyph glyphicon glyphicon-arrow-down"></span></a></li>
          </ul>
        </nav>
        ...
        <div class="legend">
          <c:if test="${requestScope.laundryRoom == 1}">
            <small><span class="label" id="blue">Laundrymachine A1</span> <b>-</b> <span
                class="label" id="yellow">Laundrymachine A2</span>
            </small>
          </c:if>
          <c:if test="${requestScope.laundryRoom == 2}">
            <small><span class="label" id="blue">Laundrymachine B1</span> <b>-</b> <span
                class="label" id="yellow">Laundrymachine B2</span>
            </small>
          </c:if>
          <c:if test="${requestScope.laundryRoom == 3}">
            <small><span class="label" id="blue">Laundrymachine C1</span> <b>-</b> <span
                class="label" id="yellow">Laundrymachine C2</span>
            </small>
          </c:if>
        </div>
        ...
        <div class="legend">
          <c:if test="${requestScope.laundryRoom == 1}">
            <small><span class="label" id="green">Dryer A3</span> <b>-</b> <span
                class="label" id="red">Dryer A4</span>
            </small>
          </c:if>
          <c:if test="${requestScope.laundryRoom == 2}">
            <small><span class="label" id="green">Dryer B3</span> <b>-</b> <span
                class="label" id="red">Dryer B4</span>
            </small>
          </c:if>
          <c:if test="${requestScope.laundryRoom == 3}">
            <small><span class="label" id="green">Laundrymachine C3</span> <b>-</b>
              <span class="label" id="red">Laundrymachine C4</span>
            </small>
          </c:if>
        </div>
...
<div class="modal fade" id="modify_account_password_modal" role="dialog"
     data-controls-modal="modify_account_password_modal" data-backdrop="static"
     data-keyboard="false">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="center_modal_top_close_button close"
                data-dismiss="modal">&times;
        </button>
        <h4 class="center_modal_header form-signin-heading">Change Password</h4>
      </div>
      <form name="modify_account_password" class="form-signin" action="index.010"
            method="post">
        <div class="modal-body">
          <div class="row">
            <div class="col-xs-9 col-xs-offset-1">
              <input id="password" name="password" type="password"
                     class="form-control settings_modal"
                     placeholder="New Password" required/> <br>
              <input id="confirm_password" type="password" class="form-control"
                     placeholder="Retype Password" pattern=""
                     required title="Password not identical"/>
              <input name="to_servlet" value="changePassword" style="display: none;"
                     required>
              <input value="${requestScope.week}" name="week" type="text"
        ...
        <div class="modal-footer">
          ...
          <button class="btn btn-default" type="button" onclick="hideBlueBackground()"
                  data-dismiss="modal">
...
<div class="modal fade" id="delete_account_modal" role="dialog"
     data-controls-modal="delete_account_modal"
          ...
          <div class="row">
            <div class="col-xs-9 col-xs-offset-1">
              <input name="password" type="password"
                     class="form-control settings_modal" placeholder="Type password"
                     required/>
              <input name="to_servlet" value="deleteAccount" style="display: none;"
                     required>
              <input value="${requestScope.week}" name="week" type="text"
                     style="display: none;"><input
                value="${requestScope.laundryRoom}" name="laundryRoom" type="number"
      ...
      <form name="appointment_form" class="form-signin" action="index.010" method="post">
        <div class="modal-body inputSpread">
          <div class="row">
            ...
            <div class="col-xs-8 .col-xs-offset-4">
              ...
              <select name="day" class="form-control pull-right day_class">
                <c:if test="${requestScope.week != 'next'}">
                  <c:forEach items="${date}" var="entry" varStatus="loop"
                             begin="0" end="6">
            ...
            <div class="col-xs-8 .col-xs-offset-4">
              ...
              <select name="machine" class="form-control machine_class">
                <c:if test="${requestScope.laundryRoom != 2 && requestScope.laundryRoom != 3}">
                  <c:forEach items="${wasmachine}" var="entry" varStatus="loop"
                             begin="0" end="3">
                    <option value="${entry.key}">${entry.value}</option>
                  </c:forEach>
                </c:if>
          ...
          <div class="row">
            ...
            <div class="col-xs-8 .col-xs-offset-4">
              <input value="${sessionScope.user.houseNumber}" name="huisnummer"
                     type="text"
          ...
          <div class="row">
            ...
            <div class="col-xs-8 .col-xs-offset-4">
              <input id="remaining" value="" name="wash_counter" type="text"
                     class="form-control pull-right readonly"
                     placeholder="Not Logged In!" readonly>
            </div>
          </div>

          <input value="${sessionScope.user.id}" name="id" type="number"
                 style="display: none;" required> <input
            name="to_servlet"
            value="addAppointment" style="display: none;">
          <input class="machineType" value="" name="machinetype" type="text"
                 style="display: none;">
          <input value="${requestScope.week}" name="week" type="text"
                 style="display: none;"><input
            value="${requestScope.laundryRoom}" name="laundryRoom" type="number"
...
<div class="modal fade" id="delete_appointment_modal" role="dialog"
     data-controls-modal="delete_appointment_modal"
     data-backdrop="static"
     data-keyboard="false">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <form name="delete_appointment_form" class="form-signin" action="index.010"
            method="post">
        ...
        <div class="modal-body inputSpread">
          ...
          <input class="machineType" name="machinetype" type="text"
                 style="display: none;">
          <input value="${requestScope.week}" name="week" type="text"
                 style="display: none;"><input
            value="${requestScope.laundryRoom}" name="laundryRoom" type="number"
...
<div class="modal fade" id="delete_message_modal" role="dialog"
     data-controls-modal="delete_message_modal"
     data-backdrop="static"
     data-keyboard="false">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <form name="delete_message_form" class="form-prikbord" action="index.010" method="post">
        <div class="modal-body">
          <div class="row">
            <div class="col-xs-12">
              <h5>
                Are you sure you want to remove your message with title: <br>
                <b><span id="messageTitle"></span></b>
              </h5>
              <input value="${sessionScope.user.id}" name="userId" type="number"
                     style="display: none;" required>
              <input id="messageId" name="id" value="" style="display: none;"
                     required>
            </div>
          </div>
        </div>
...
<div class="modal fade" id="prikbord_modal" role="dialog" aria-labelledby="myModalLabel"
     data-controls-modal="prikbord_modal" data-backdrop="static"
     data-keyboard="false">
      ...
      <form name="prikbord_form" class="form-prikbord" action="index.010" method="post">
        ...
        <div class="modal-body inputSpread">
          ...
          <div class="row">
            ...
            <div class="col-xs-10 .col-xs-offset-2">
              <input value="${sessionScope.user.email}"
                     id="space_for_span_prikbord_input" name="userEmail" type="text"
                     class="form-control pull-right readonly"
                     placeholder="Not Logged In!" readonly> <span
                class="shrink_glyph glyphicon glyphicon-question-sign"
                data-toggle="tooltip" data-placement="left"
...
<div id="error_message_modal" class="modal fade" tabindex="-1" role="dialog"
     aria-labelledby="mySmallModalLabel"
     role="dialog" data-controls-modal="error_message_modal"
     data-keyboard="true">
  <div class="modal-dialog">

    <div id="alert_div" class="alert alert-success">
      <a href="" class="close" data-toggle="modal" data-target="#error_message_modal"><span
...
<script>
  $(document).ready(function () {
    ...
    var nowTimePlus5Min = nowPlus5Min.getHours() + ':' + nowPlus5Min.getMinutes() + ":"
        + nowPlus5Min.getSeconds();

    var nowPlus30Min = new Date(now.getTime() + (30 * 60000));
    var nowTimePlus30Min = nowPlus30Min.getHours() + ':' + nowPlus30Min.getMinutes() + ":"
        + nowPlus30Min.getSeconds();
    ...
    var placeHoverEffectClass = function () {
      if (thisWeek) {
        ...
        var timeIndex = i % 13;
        var nowOrWithin5min_Time = Date.parse("1/1/1970 " + dbTimesArray[timeIndex]) >= Date.parse(
                "1/1/1970 " + nowTimePlus5Min);
        var nowOrWithin30min_Time = Date.parse("1/1/1970 " + dbTimesArray[timeIndex]) >= Date.parse(
                "1/1/1970 " + nowTimePlus30Min);
