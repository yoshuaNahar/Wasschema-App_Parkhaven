    ...
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand mainTitle" href="${pageContext.request.contextPath}/index.010">
                <img id="menu_img"
                     src="${pageContext.request.contextPath}/resources/img/parkhaven-logo.png"/><span
                    id="menu_span">Wasschema</span>
            </a>
        </div>
                                ...
                                <div class="panel-body">
                                    <c:if test="${requestScope.laundryRoom != 1 && requestScope.laundryRoom != 2 && requestScope.laundryRoom != 3}">
                                        <a class="settings_link"
                                           style="color: #CACACA; pointer-events: none; display: inline-block;"
