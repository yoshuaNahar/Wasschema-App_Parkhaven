...
public class MailService {
  ...
  private static final DateTimeFormatter TIME_FORMATTER_WITHOUT_SECONDS = DateTimeFormatter
  ...
  public void sendMailThreeHoursReminder(User user) {
    ...
    Duration tenSecondsToMakeSureInNextMinute = Duration.ofSeconds(
        10); // Sometimes I get 16:59:59 seconds, which will become 16:59 which I dont want.
    ...
    try {
      ...
      message.setContent("<body> "
              ...
              + "<h4>This mail is to remind you that you have a laundry appointment at "
              + TIME_FORMATTER_WITHOUT_SECONDS.format(afterThreeHours) + "</h4>"
              + "Laundry room: " + user.getPassword().charAt(0) + ", laundry machine: " + user
              .getPassword() + ".</h4>"
              + "<br>"
