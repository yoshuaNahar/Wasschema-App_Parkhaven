...
public class MetaDataDao {
    ...
    private static final String SELECT_COUNTER_SUM = "SELECT counter FROM metadata WHERE counter_type = ? ORDER BY counter DESC LIMIT 1";
    ...
    public void insertCounter(int counter, String type) {
        this.template.update(ADD_META_DATA, counter, type);
    }
